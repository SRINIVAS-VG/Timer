...
//getting value from user and check if it is eligible to create timer
...
// creating the required elements to display the timer 
...
// display after the timer is exhausted
